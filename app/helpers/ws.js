...
import { rts, stripProtocol } from 'helpers/utils';


class WebSocketHandler {
  constructor(url, timestamp, params, currMode, dispatch, remoteBrowser = false, reqId = null, host = '') {
    const { user, coll, splat, ts } = params;
